 ...
 * equality checking, hashing, and string representation.
 */
public class Coord {
    ...
    /**
     * Compares this {@code Coord} with another object for equality. Two {@code Coord}
     * objects are considered equal if they have the same row and column values.
     *
     ...
     *         same row and column values; {@code false} otherwise.
     */
    @Override
