 ...
 * descriptive information, and associated sprite. This information is used to render and 
 * categorize buildings on a map.
 */
public class BuildingInfo {
    ...
    /**
     * Constructs a {@code BuildingInfo} instance with specified type, tile coverage, description, 
     * and sprite.
     *
